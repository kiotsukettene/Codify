...
// const isStudentAuthenticated = useStudentStore((state) => state.isAuthenticated);
...
//         <Route 
//   path="/student-login" 
//   element={isStudentAuthenticated ? <Navigate to="/student/dashboard" replace /> : <StudentLoginPage />} 
// />
