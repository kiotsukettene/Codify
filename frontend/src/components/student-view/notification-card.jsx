...
import ViewAllNotifications from "./view-all-notifications"

const isDev = import.meta.env.MODE === "development"
const API_URL = isDev ? "http://localhost:3000/api/battles" : `${import.meta.env.VITE_API_URL}/api/battles`

export default function NotificationCard() {
  const { notifications, unreadNotifications, markNotificationAsRead, dismissNotification } = useBattleStore()
