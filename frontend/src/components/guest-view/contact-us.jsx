...
const AnimatedInput = ({ label, id, name, type = "text", value, onChange, placeholder, required }) => {
  const [isFocused, setIsFocused] = useState(false)

  return (
    <div className="mb-5">
      <label htmlFor={id} className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2 font-nunito">
        {label}
      </label>
    ...
    <div className="relative min-h-screen w-full  flex items-center justify-center p-4 md:p-8 font-nunito">
      ...
      <div className="w-full max-w-6xl flex flex-col md:flex-row gap-6">
        ...
        <Card className="md:w-2/5 overflow-hidden rounded-3xl shadow-xl bg-primary text-white transform transition-all duration-300 hover:translate-y-[-5px] hover:shadow-2xl">
          <div className="p-8 md:p-10">
            ...
            <div className="space-y-4">
              ...
              <ContactOption icon={MapPin} title="Location" description="123 Tech Avenue, San Francisco" href="#" />
        ...
        <Card className="md:w-3/5 overflow-hidden rounded-3xl shadow-xl bg-white dark:bg-gray-800 transform transition-all duration-300 hover:shadow-2xl">
          <div className="p-8 md:p-10">
            <h2 className="text-2xl font-bold mb-6 text-gray-800 dark:text-white font-nunito">Send us a message</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              >
                <span className="relative z-10 flex items-center justify-center">
                  ...
                  <PaperPlane
                    className={`ml-2 h-5 w-5 transition-all duration-300 ${isHovered ? "translate-x-1 -translate-y-1" : ""}`}
                  />
                </span>
              </Button>
