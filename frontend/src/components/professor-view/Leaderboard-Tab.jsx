...
// Static avatar mapping (alternating for demo)
const avatars = [dog, bear];
...
const Leaderboard = () => {
  ...
  useEffect(() => {
    if (!isLoadingLeaderboard && !leaderboardError) {
      setIsLoaded(true);
    }
  ...
  const handleImageError = (id) => {
    console.log(`Image error for student ${id}`);
  };
  ...
  return (
    <div className="w-full">
      <div className="mx-auto flex flex-col items-center">
        ...
        {/* Top 3 Students */}
        {currentPage === 1 && topThreeStudents.length > 0 && (
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
                ...
                <div className="relative">
                  ...
                  >
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      ...
                      <div className="w-[70%] h-[70%] rounded-full overflow-hidden border-4 border-white z-10">
                        <img
                          ...
                          onError={() => handleImageError(topThreeStudents[0].id)}
                        />
                      </div>
                    </div>
                    <motion.div
                    ...
                    <div className="absolute -bottom-2 right-0 bg-white rounded-full px-2 sm:px-3 py-1 text-xs sm:text-sm font-medium shadow-md z-20">
                      {topThreeStudents[0].totalPoints}
                    </div>
                  </motion.div>
                </div>
                <h3 className="text-[#F7C948] font-semibold text-base sm:text-lg md:text-xl mt-2 sm:mt-3 text-center truncate w-full">
                  {topThreeStudents[0].name}
                </h3>
              ...
              >
                ...
                <div className="relative">
                  ...
                  >
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      ...
                      <div className="w-[70%] h-[70%] rounded-full overflow-hidden border-4 border-white z-10">
                        <img
                          ...
                          className="w-full h-full object-cover"
                          onError={() => handleImageError(topThreeStudents[1].id)}
                        />
                      </div>
                    </div>
                    <motion.div
                    ...
                    <div className="absolute -bottom-2 right-0 bg-white rounded-full px-2 sm:px-3 py-1 text-xs sm:text-sm font-medium shadow-md z-20">
                      {topThreeStudents[1].totalPoints}
                    </div>
                  </motion.div>
                </div>
                <h3 className="text-[#B088E0] font-semibold text-sm sm:text-base md:text-lg mt-2 sm:mt-3 text-center truncate w-full">
                  {topThreeStudents[1].name}
                </h3>
              ...
              >
                ...
                <div className="relative">
                  ...
                  >
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      ...
                      <div className="w-[70%] h-[70%] rounded-full overflow-hidden border-4 border-white z-10">
                        <img
                          ...
                          className="w-full h-full object-cover"
                          onError={() => handleImageError(topThreeStudents[2].id)}
                        />
                      </div>
                    </div>
                    <motion.div
                    ...
                    <div className="absolute -bottom-2 right-0 bg-white rounded-full px-2 sm:px-3 py-1 text-xs sm:text-sm font-medium shadow-md z-20">
                      {topThreeStudents[2].totalPoints}
                    </div>
                  </motion.div>
                </div>
                <h3 className="text-gray-500 font-semibold text-sm sm:text-base md:text-lg mt-2 sm:mt-3 text-center truncate w-full">
                  {topThreeStudents[2].name}
                </h3>
