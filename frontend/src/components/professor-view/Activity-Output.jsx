  ...
  return (
    <div className="flex items-center gap-1">
      <div className={`
        ...
        ${isFocused ? 'ring-2 ring-purple-200 bg-white' : 'bg-gray-50'}
      `}>
        <Input
          type="number"
          min="0"
          max="100"
          className="w-16 text-right border-none bg-transparent focus:ring-0 focus-visible:ring-0 focus:outline-none"
          value={value || ''}
