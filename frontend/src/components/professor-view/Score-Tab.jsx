...
const ScoreTab = ({ metrics, students, activities }) => {
  return (
      ...
      <Card className="overflow-x-auto">
        <div className="rounded-md border min-w-[600px]">
          <div className="grid grid-cols-12 gap-2 sm:gap-4 bg-purple-50 p-2 sm:p-4">
            <div className="col-span-4 font-medium text-sm sm:text-base">
              Student Name
            </div>
            <div className="col-span-3 text-center font-medium text-sm sm:text-base">
              Activities
            </div>
            <div className="col-span-3 text-center font-medium text-sm sm:text-base">
              Incomplete
