...
function LandingPage() {
  ...
  return (
    <main className="bg-gradient-to-b from-indigo-700 via-pink-200 to-blue-100">
        ...
        <div className="w-full md:w-1/2 p-6 lg:p-12">
          <div className="max-w-2xl mx-auto">
            ...
            <p className="mt-6 text-lg text-gray-600 leading-relaxed">
              Experience the elegance of beautifully handcrafted templates designed to elevate your digital presence.
            </p>
...
<section className="min-h-screen bg-white py-8 flex justify-center items-center">
