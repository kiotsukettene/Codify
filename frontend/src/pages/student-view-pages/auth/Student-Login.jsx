    ...
    return (
        ...
        <Card className="p-6 sm:p-10 rounded-3xl shadow-sm">
          ...
          {error && <p className="text-red-500 text-sm">{error}</p>}
           ...
           <motion.button onClick={handleLogin} className="w-full h-10  mx-auto justify-center items-center text-center  sm:h-12 text-sm sm:text-[15px] bg-[#7C3AED] hover:bg-[#6D28D9] rounded-md text-white" 
