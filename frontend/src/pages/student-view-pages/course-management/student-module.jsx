    ...
    <div>
      <Breadcrumb>
        <BreadcrumbList>
          ...
          <BreadcrumbItem>
            <BreadcrumbLink>
              <Link to="/student/lesson-list">Course</Link>
            </BreadcrumbLink>
          </BreadcrumbItem>
          <BreadcrumbSeparator />
          ...
          <BreadcrumbItem>
            <BreadcrumbLink>
              <Link to="/student/module">Lesson</Link>
            </BreadcrumbLink>
          </BreadcrumbItem>
          <BreadcrumbSeparator />
          ...
          <BreadcrumbItem>
            <BreadcrumbLink>
              <Link to="/student/activity-list">Activity</Link>
            </BreadcrumbLink>
          </BreadcrumbItem>
          <BreadcrumbSeparator />
      ...
      <div className="flex flex-row mt-5">
        <div className="w-full lg:w-3/4">
          ...
          <div className="w-full lg:w-1/4 px-5">
            <Card className="relative flex items-center justify-between mb-5 p-4 md:p-6 border-none shadow-none h-16 md:h-20 rounded-3xl max-w-[200px] md:max-w-md"
            ...
            <Accordion type="single" collapsible className="w-full bg-white rounded-lg shadow-none border-none p-4">
                    ...
                    {topics.map((topic) => (
                      <div key={topic.id}
                        className={`relative flex items-center justify-between p-4 hover:bg-gray-50 cursor-pointer transition-all duration-300 rounded-lg ${
                          topic.isActive ? "bg-purple-50 border-l-4 border-purple-500"
                          : topic.isCompleted ? "bg-green-50 border-l-4 border-green-500" : ""
                        }`}
                      >
                        <div className="pl-4">
                          <h3 className="font-medium text-gray-900">
                            ...
                            {topic.isCompleted && (
                              <span className="ml-2 text-sm text-green-600">+{topic.xp} XP</span>
                            )}
                          </h3>
                        </div>
                        {topic.isCompleted ? (
