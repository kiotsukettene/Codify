...
function StudentModulePage() {
  ...
  const topics = [
    ...
    { id: 2, title: "What is Lan?", icon: PlayCircle, isLocked: false, xp: 10 },
    {
      id: 3,
      ...
      <div className="flex flex-row mt-5">
            ...
            <div className="mt-5">
              <Tabs defaultValue="lesson">
                <TabsList className="space-x-6">
                  <TabsTrigger value="lesson" className="hover:text-primary">
                    Lesson
                  </TabsTrigger>
                  <TabsTrigger value="activity" className="hover:text-primary">
                    Activity
                  </TabsTrigger>
                </TabsList>
                ...
                <TabsContent value="activity">content 2</TabsContent>
              </Tabs>
            </div>
          </Card>
        </div>
        ...
        <div className="w-full lg:w-1/4 px-5">
          ...
          >
            ...
            {/* Astronaut Image - Now Fully Aligned to the Right */}
