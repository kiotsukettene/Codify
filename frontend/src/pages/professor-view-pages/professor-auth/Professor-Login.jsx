      ...
      <CardContent className="space-y-4 p-0 mt-6 sm:mt-8">
        ...
        <div className='relative'>
          ...
          <button
            ...
            {isPasswordVisible ? <Eye className="text-gray-700" /> : <EyeOff className="text-gray-700" />}
          </button> 
        </div>
        ...
        <div className="flex items-center justify-between pt-2">
          ...
          <div className="flex items-center space-x-2">
            ...
            <Button variant="link" className="px-0 text-[#4F46E5] hover:text-[#4338CA] font-normal text-xs sm:text-sm">
              Forgot password?
            </Button>
        </div>
