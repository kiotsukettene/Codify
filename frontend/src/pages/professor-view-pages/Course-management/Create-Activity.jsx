...
import { ArrowLeft, ChevronDown, Users, Copy, Upload, FileIcon, X } from "lucide-react"
...
const CreateActivity = () => {
      ...
      <CardContent className="p-0">
        ...
        <div className="mb-6">
            <div className="flex justify-between mb-2">
                <span className="text-sm text-gray-600">Activity Creation Progress</span>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            <ToggleGroup type="multiple" className="justify-start" value={textFormat} onValueChange={setTextFormat}>
  ...
  <div className="col-span-3">
    ...
    <div className="mt-8">
      ...
      >
        <Upload className={`h-10 w-10 ${files.length === 0 ? 'text-gray-500' : 'text-purple-600'}`} />
        <span className={`text-sm ${files.length === 0 ? 'text-gray-500' : 'text-purple-600'}`}>
          + Add New File
        </span>
        <input 
          type="file" 
