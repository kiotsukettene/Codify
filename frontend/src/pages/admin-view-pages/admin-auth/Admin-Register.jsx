...
function AdminRegisterPage() {
  ...
  // Set "Standard Codify Subscription" as default selected
            ...
            <form onSubmit={handleAdminRegister} className="p-6 m-0 md:p-8 grid md:grid-cols-2 gap-4">
              <div className="flex flex-col gap-6">
                ...
                <div className="flex flex-col space-y-1">
                  <h1 className="text-xl font-semibold">Institution Registration</h1>
                  <p className="text-xs text-muted-foreground text-justify">
                    Register your institution and complete payment to get started.
                  </p>
                </div>
              ...
              <div className="flex flex-col gap-6 p-6" style={{ backgroundColor: "#F8F4FF" }}>
                ...
                <div className="flex text-xs text-muted-foreground w-full justify-between mt-5 text-justify gap-2">
                  <LockKeyhole />
                  <p>Guaranteed to be safe & secure, ensuring that all transactions are protected.</p>
                </div>

                <div>
                  <Label className="text-xl font-semibold pt-11">Starter Plan</Label>
                  <div className="mt-3">
                    <button
                      type="button"
                    ...
                    >
                      ...
                      >
                        <div className="flex items-center gap-4">
                          ...
                          >
                            {isSelected && <Circle className="h-3 w-3 fill-[#7C3AED] text-[#7C3AED]" />}
                          </div>
                          <div className="flex flex-col items-start">
                            <h3 className="font-semibold text-gray-900">Standard Codify Subscription</h3>
